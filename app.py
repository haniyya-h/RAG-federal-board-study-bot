...
A RAG-based chatbot for Federal Board students using ChromaDB + OpenAI
"""

import streamlit as st
import os
# json import removed - no longer loading SLO data
...
import time
# sentence_transformers removed - SLO questions now generated by Gemini
import numpy as np
...
# SLO questions are now generated dynamically by Gemini
...
@st.cache_resource
# SLO data loading removed - questions are now generated dynamically

# sentence transformer function removed - SLO questions now generated by Gemini
...
def format_response(answer, relevant_docs, slo_questions):
    ...
    # Add SLO questions in a friendly way
    if slo_questions:
